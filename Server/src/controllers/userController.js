...
export const getCartData = async (req, res, next) => {
  try {
    ...
    cartData.items.forEach(item => {
      ...
      // Check if the stored itemTotal matches the recalculated value
    ...
    // Check if the stored cartTotal matches the recalculated value
    if (cartData.cartTotal !== recalculatedCartTotal || updatedItems) {
      cartData.cartTotal = recalculatedCartTotal;
      await cartData.save(); // Save if there were any updates
    }
